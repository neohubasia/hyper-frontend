...
var GOOGLE_CONSUMER_KEY =
  "205154145545-i3aimr08cmvffild3iemv5dvuahlieod.apps.googleusercontent.com";
...
module.exports = new GoogleStrategy(
  {
    ...
    callbackURL:
      "https://itemplate-marketplace.herokuapp.com/auth/google/callback",
  ...
  function (request, accessToken, refreshToken, profile, done) {
    ...
    axiosHandler.module
      .post("/c-api/customer_signup", signupObj)
      .then((response) => {
